...
export default function AnnouncementBanner() {
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-50 h-9 bg-gradient-to-r from-gold-800 via-gold-900 to-gold-800 dark:from-gold-900 dark:via-gold-950 dark:to-gold-900 overflow-hidden select-none">
