...
import { X, Users, Compass, Database, ShieldAlert, Award, FileSpreadsheet, Search, CheckCircle2, Terminal } from 'lucide-react';
...
export default function StrategicBlueprint({ isOpen, onClose }: StrategicBlueprintProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-900/60 backdrop-blur-md flex justify-center items-center p-4">
      <div 
        className="bg-[#FCFBF7] w-full max-w-6xl rounded-2xl shadow-2xl border border-gold-200 overflow-hidden flex flex-col max-h-[90vh]"
      ...
      >
        ...
        {/* Tab Selection */}
        <div className="flex border-b border-gold-200/20 bg-gold-50/20 overflow-x-auto scroller-none">
          {[
            { id: 'psychology', label: 'Customer Psychology Matrix', icon: Users },
            { id: 'competitors', label: 'Competitor Analysis', icon: ShieldAlert },
            { id: 'ui_blueprint', label: 'UX Storytelling Map', icon: Compass },
            { id: 'seo', label: 'SEO Domination Blueprint', icon: Search },
            { id: 'architecture', label: 'Enterprise Architecture & DB', icon: Database }
          ].map((t) => {
            const Icon = t.icon;
            const isSelected = activeTab === t.id || (t.id === 'ui_blueprint' && activeTab === 'ux');
            return (
              <button
                key={t.id}
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
              ...
              <div className="lg:col-span-8 bg-white/70 border border-gold-200/30 rounded-2xl p-6 shadow-xs overflow-y-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h5 className="text-[11px] font-mono uppercase tracking-wider text-red-600 font-bold mb-2 flex items-center gap-1.5">
                  ...
                  <div>
                    <h5 className="text-[11px] font-mono uppercase tracking-wider text-green-700 font-bold mb-2 flex items-center gap-1.5">
                  ...
                  <div>
                    <h5 className="text-[11px] font-mono uppercase tracking-wider text-gold-700 font-bold mb-2 flex items-center gap-1.5">
                  ...
                  <div>
                    <h5 className="text-[11px] font-mono uppercase tracking-wider text-blue-700 font-bold mb-2 flex items-center gap-1.5">
                  ...
                  <div className="md:col-span-2 border-t border-gold-200/20 pt-4 mt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-[#2D2926] text-gold-100 p-3 rounded-lg text-xs">
          ...
          {activeTab === 'ux' && (
            <div className="space-y-8">
              ...
              <div className="bg-[#2D2926] text-gold-100 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-center">
          ...
          {activeTab === 'seo' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    {keywordClusters.map((cluster, idx) => (
                      <div key={idx} className="p-4 bg-white border border-gold-200/30 rounded-xl shadow-xs">
                        <div className="flex items-center justify-between mb-2">
                          <span className="font-serif font-bold text-[#2D2926] text-sm">{cluster.topic}</span>
              ...
              <div className="lg:col-span-6 space-y-6">
                <div>
                  <h4 className="text-xs font-mono uppercase tracking-widest text-[#2D2926] mb-3">Dynamically Injected Schema.org Local SEO Block</h4>
                  <div className="bg-[#1e1e1e] rounded-xl p-4 text-gold-200 font-mono text-xs overflow-x-auto max-h-[300px]">
          ...
          {/* 5. Enterprise Architecture Details */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-7">
                <h4 className="text-xs font-mono uppercase tracking-widest text-gold-600 mb-3 flex items-center gap-1.5">
                  ...
                  Prisma Database Schema Models (PostgreSQL Core)
                </h4>
                <div className="bg-[#1e1e1e] text-green-400 font-mono text-[10px] sm:text-xs rounded-xl p-4 overflow-x-auto max-h-[400px]">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div>
                  <h4 className="text-xs font-mono uppercase tracking-widest text-gray-400 mb-3">Simulated High-Speed Cache Rules</h4>
